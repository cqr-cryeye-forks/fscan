...
type ScanStatus struct {
	...
	lastError   time.Time    // 最近一次 mistake的时间
}
...
const (
	...
	LogLevelError   = "ERROR"   // 仅显示 mistake日志
...
var logColors = map[string]color.Attribute{
	LogLevelError:   color.FgBlue,   //  mistake日志显示蓝色
...
// LogError 记录 mistake日志，自动包含文件名和行号信息
